...
If you start a game and perform only infantry kills, these 3 values will be the same.  
This makes it "easy" to find the positions in-memory.  
(Ex: Start the game and make a sniper, scanning for 0..3 is almost certain to locate it)

Once the positions has been found, perform a pointer scan, restart the game, and find the addresses again.  
In the pointer scan, scan to the new address, and repeat.. after 3-4 games, the pointer chain should be located.
...
[Area chart documentation](https://rma-consulting.github.io/react-easy-chart/area-chart/index.html)

[How to use cheat engine](https://www.unknowncheats.me/forum/programming-for-beginners/110375-cheat-engine-finding-base-address-pointer-scan.html)
